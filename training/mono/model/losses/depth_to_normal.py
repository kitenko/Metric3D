...
class Backprojection(nn.Module):
    ...
    def __init__(self, height, width):
        ...
        xy = torch.unsqueeze(torch.stack([id_coords[0].view(-1), id_coords[1].view(-1)], 0), 0)
        ...
        self.horizontal_samples = np.arange(
            self.horizontal_angle_range[0], self.horizontal_angle_range[1], self.horizontal_step
        )
        self.vertical_samples = np.arange(
            self.vertical_angle_range[0], self.vertical_angle_range[1], self.vertical_step
        )
