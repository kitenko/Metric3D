    ...
    def get_regular_lr(self, _iter, optimizer):
        ...
        if isinstance(optimizer, dict):
            ...
            for k in optimizer.keys():
                _lr_group = [self.get_lr(_iter, max_iters, _base_lr) for _base_lr in self.base_lr[k]]
...
def save_ckpt(cfg, model, optimizer, scheduler, curr_iter=0, curr_epoch=None, loss_scaler=None):
    ...
    ckpt = dict(
        ...
        max_iter=cfg.runner.max_iters if "max_iters" in cfg.runner else cfg.runner.max_epoches,
