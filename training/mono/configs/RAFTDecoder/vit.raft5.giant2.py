...
# schedule
lr_config = dict(
    policy="poly", warmup="linear", warmup_iters=1000, warmup_ratio=1e-6, power=0.9, min_lr=1e-6, by_epoch=False
)
    ...
    data=dict(
        train=dict(
            pipeline=[
                ...
                dict(type="RandomResize", prob=0.5, ratio_range=(0.85, 1.15), is_lidar=True),
                dict(
                    type="RandomCrop",
    ...
    data=dict(
        train=dict(
            pipeline=[
                dict(type="BGR2RGB"),
                dict(type="LabelScaleCononical"),
                dict(type="RandomResize", ratio_range=(0.85, 1.15), is_lidar=False),
                dict(
                    type="RandomCrop",
                    crop_size=(0, 0),  # crop_size will be overwriteen by data_basic configs
                    crop_type="rand",
    ...
    data=dict(
        train=dict(
            pipeline=[
                dict(type="BGR2RGB"),
                dict(type="LabelScaleCononical"),
                dict(type="RandomResize", prob=0.5, ratio_range=(0.85, 1.15), is_lidar=False),
                dict(
                    type="RandomCrop",
                    crop_size=(0, 0),  # crop_size will be overwriteen by data_basic configs
                    crop_type="rand",
    ...
    data=dict(
        train=dict(
            pipeline=[
                dict(type="BGR2RGB"),
                dict(type="LabelScaleCononical"),
                dict(type="RandomResize", prob=0.5, ratio_range=(0.75, 1.3), is_lidar=False),
                dict(
                    type="RandomCrop",
                    crop_size=(0, 0),  # crop_size will be overwriteen by data_basic configs
                    crop_type="rand",
